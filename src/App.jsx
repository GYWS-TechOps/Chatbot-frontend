...
//       {isOpen && (
//         <div className={`w-92 max-w-[90vw] h-[450px] bg-white rounded-3xl shadow-2xl flex flex-col absolute bottom-16 right-0 transform transition-all duration-300 ease-in-out border border-gray-100 overflow-hidden ${isOpen ? "scale-100 opacity-100" : "scale-95 opacity-0 pointer-events-none"}`}>
...
export default function App() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50" ref={chatbotRef}>
      {isOpen && (
        <div className={`w-92 max-w-[90vw] h-[450px] bg-white rounded-3xl shadow-2xl shadow-yellow-500 flex flex-col absolute bottom-16 right-0 transform transition-all duration-300 ease-in-out border border-gray-100 overflow-hidden ${isOpen ? "scale-100 opacity-100" : "scale-95 opacity-0 pointer-events-none"}`}>
